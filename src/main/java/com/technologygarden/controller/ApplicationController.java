...
public class ApplicationController {
    ...
    public ResultBean<Integer> insertApplicationAdmission(@RequestBody ApplicationAdmission applicationAdmission) throws IOException {
        FilUploadUtils.saveFile(applicationAdmission.getBlFile());//保存文件
        applicationAdmission.setId(applicationAdmission.getRole().getInfoid());
        applicationAdmission.setFileName(applicationAdmission.getBlFile().getOriginalFilename());//获取文件名
