...
public class NoticeController {
    ...
    public ResultBean<Page<Notice>> getNoticeListByPage(@NonNull Integer pageNum, @NonNull Integer pageSize){
    ...
    public ResultBean<Page<Notice>> searchNoticeByPage(@NonNull Integer pageNum, @NonNull Integer pageSize, String title, Integer status){
