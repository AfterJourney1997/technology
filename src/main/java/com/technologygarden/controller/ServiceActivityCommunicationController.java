...
public class ServiceActivityCommunicationController {
    ...
    @RequestMapping(value = "/activityCommunication", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/activityCommunication", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/activityCommunication", method = RequestMethod.DELETE)
    ...
    @RequestMapping(value = "/activityCommunication", method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/activityCommunication/search", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/activityCommunication/activityCategory", method = RequestMethod.GET)
